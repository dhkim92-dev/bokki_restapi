...
export const CREATE_INTERVIEW_REVIEW_SUCCESS : ResultCode = {status: 201, code: "IR-001", message: "면접 복기를 추가하였습니다."};
export const GET_INTERVIEW_REVIEW_SUCCESS : ResultCode = {status: 200, code: "IR-002", message: "면접 복기를 조회하였습니다."};
export const GET_INTERVIEW_REVIEW_LIST_SUCCESS : ResultCode = {status: 200, code: "IR-003", message: "면접 복기 목록을 조회하였습니다."};
